    ...
    <div className='relative bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center'>
        <div className='max-w-3xl mx-auto'>
            ...
            <form className='flex items-center bg-white dark:bg-gray-800 rounded-full shadow-lg overflow-hidden max--w-xl mx-auto'>
                <Input placeholder="Search courses" type='text' className='flex-grow border-none focus-visible:ring-0 px-6 py-3 text-gray-900 dark:text-gray-100' ></Input>
            ...
            <Button className='bg-white dark:bg-gray-800 text-blue-600 rounded-full hover:bg-gray-200 mt-8'>Explore courses</Button>
        </div>
    </div>
  )
}
